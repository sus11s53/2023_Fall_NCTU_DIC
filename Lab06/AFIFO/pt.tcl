...
set link_path "* asap7sc7p5t_INVBUF_RVT_TT_08302018.db asap7sc7p5t_SIMPLE_RVT_TT_08302018.db asap7sc7p5t_SEQ_RVT_TT_08302018.db"
...
#  set_annotated_check -0 -setup -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
#  set_annotated_check -0 -hold  -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
#}

foreach_in_collection x [get_cell */sync_r2w_m0/wq1_rptr_reg_*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
}

foreach_in_collection x [get_cell */sync_w2r_m0/rq1_wptr_reg_*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CLK -to [get_object_name $x]/D -clock rise
}
